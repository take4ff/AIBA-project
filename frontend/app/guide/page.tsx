...
モメンタム = (MA位置 + RSI勢い + 直近上昇) / 3`}</pre>
      ...
      <section className="layer def-section">
        ...
        <ul className="def-list">
          ...
          <li><strong>テクニカル総合判定（買い・売り目安の網羅）</strong>：移動平均(25/200)・MACD・一目均衡表（<strong>トレンド系＝順張りの方向</strong>）と RSI・ボリンジャー（<strong>オシレーター系＝売られすぎ/買われすぎ</strong>）を各々 買い/売り/中立 に評価し、総合の傾き（買い寄り〜売り寄り）を提示。銘柄詳細に一覧表示。</li>

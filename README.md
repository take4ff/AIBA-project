...
### 横断・補助
- **地域タブ**（Global / 米国 / 日本）× **業界ETF / 個別株トグル**
...
- **センチメント（先行）**：GitHub（新規リポジトリ＋**コミット活動量**）× arXiv（論文）× **Hacker News** の平均増加率
...
`Global / 米国 / 日本 / ⭐Pickup / ☆お気に入り / 💼マイ・ポートフォリオ`（全ページ共通ナビ）
...
```
yfinance / GitHub API / arXiv API / Hacker News
        │ 収集・スコア計算・予測（Python）

...
LAYER_WEIGHTS: dict[int, tuple[float, float]] = {
    # v1.2(2026-06): クロスセクションICの再評価（本物のセンチメント=2025+）で第1層は
    #   純センチIC +0.146 / 純テク 負 と判明 → 第1層をセンチメント寄りへ（0.7/0.3→0.4/0.6）。
    #   単一レジーム・18ヶ月のため一部テクニカルを残すバランス型。第2/3層は据置。
    1: (0.40, 0.60),  # 現在のブーム: センチメント寄り（中間）
